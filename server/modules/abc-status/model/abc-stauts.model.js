...
const TolfaAbcStatus = rogerSequelize.define(
  "tolfa_abc_status",
  {
    id: {
...
TolfaAbcStatus.sync({ alter: true })
  .then(() => {
    console.log("TolfaAbcStatus table created successfully.");
  })
  .catch((err) => {
    console.error("Error creating TolfaAbcStatus table:", err);
  });

module.exports = { TolfaAbcStatus };
